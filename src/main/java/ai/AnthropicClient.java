...
public final class AnthropicClient {
    ...
    public String complete(String system, String userMessage, int maxTokens) {
        return complete(system, userMessage, null, maxTokens);
    }

    /**
     * Same as {@link #complete(String, String, int)}, optionally attaching a
     * base64 PNG screenshot as an image content block (vision input).
     *
     * @param screenshotBase64Png base64-encoded PNG, or null for text-only
     */
    public String complete(String system, String userMessage, String screenshotBase64Png, int maxTokens) {
        JsonArray userContent = new JsonArray();
        if (screenshotBase64Png != null && !screenshotBase64Png.isBlank()) {
            JsonObject source = new JsonObject();
            source.addProperty("type", "base64");
            source.addProperty("media_type", "image/png");
            source.addProperty("data", screenshotBase64Png);
